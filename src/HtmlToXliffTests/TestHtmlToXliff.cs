...
namespace HtmlToXliffTests
{
	...
	public class TestHtmlToXliff
	{
		...
		{
			var converter = HtmlToXliffConverter.Parse(@"<html>
 <body>
...
*/
			...
			Assert.AreEqual("test.html", fileX.Attributes["original"].Value);
...
<p>This is only a test.</p>
		...
		{
			var converter = HtmlToXliffConverter.Parse(@"
  ...
  <table class=""statistics clear"" style=""margin-left: 6px"">
   ...
   <tr>
    <td class=""statistics-max"" data-i18n=""EditTab.Toolbox.LeveledReaderTool.Max"">Maximum</td>
		...
		{
			var converter = HtmlToXliffConverter.Parse(@"<!DOCTYPE html>
<html>
 <head>
  <meta charset=""UTF-8"">
 ...
 <body>
		...
		private void ValidateXliffOutput(string xliff, string errorMessageFormat)
		{
			try
			{
				...
				settings.Schemas.Add(null, "../../src/HtmlToXliffTests/xliff-core-1.2-transitional.xsd");
